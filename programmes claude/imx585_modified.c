...
/* ROI window control registers (compatible with IMX258/IMX477) */
#define IMX585_REG_X_ADD_STA            CCI_REG16(0x0344)
#define IMX585_REG_Y_ADD_STA            CCI_REG16(0x0346)
#define IMX585_REG_X_ADD_END            CCI_REG16(0x0348)
#define IMX585_REG_Y_ADD_END            CCI_REG16(0x034a)
...
/* =================================================================
 * Register sequences for ROI modes
 * ================================================================= */

/* 3584x2016 - Large ROI at (136,82) */
static const struct cci_reg_sequence mode_3584x2016_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 3200x1800 - Large ROI at (328,190) */
static const struct cci_reg_sequence mode_3200x1800_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 3072x2048 - Intermediate at (392,66) */
static const struct cci_reg_sequence mode_3072x2048_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 2560x1440 - Intermediate at (648,370) */
static const struct cci_reg_sequence mode_2560x1440_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 2304x1728 - Intermediate at (776,226) */
static const struct cci_reg_sequence mode_2304x1728_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 2048x2048 - Planetary at (904,66) */
static const struct cci_reg_sequence mode_2048x2048_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 1920x1080 - Planetary at (968,550) */
static const struct cci_reg_sequence mode_1920x1080_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 1600x1200 - Planetary at (1128,490) */
static const struct cci_reg_sequence mode_1600x1200_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 1280x720 - High speed at (1288,730) */
static const struct cci_reg_sequence mode_1280x720_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 1024x1024 - High speed at (1416,578) */
static const struct cci_reg_sequence mode_1024x1024_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 800x600 - High speed at (1528,790) */
static const struct cci_reg_sequence mode_800x600_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
/* 640x480 - High speed at (1608,850) */
static const struct cci_reg_sequence mode_640x480_regs_12bit[] = {
	{ CCI_REG8(0x301b), 0x00 }, /* ADDMODE non-binning */
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
...
static struct imx585_mode supported_modes[] = {
	{
		/* 1928x1090 - 2x2 binning (EXISTING) */
		.width = 1928,
		.height = 1090,
		.hmax_div = 1,
		.min_hmax = 366,
	...
	{
		/* 3856x2180 - Full resolution (EXISTING) */
		.width = 3856,
		.height = 2180,
		.hmax_div = 1,
		.min_hmax = 550,
	...
	{
		/* 3584x2016 - Large ROI ROI at (136,82) */
		.width = 3584,
		.height = 2016,
		.hmax_div = 1,
		.min_hmax = 511,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_3584x2016_regs_12bit),
			.regs = mode_3584x2016_regs_12bit,
		},
	},
	{
		/* 3200x1800 - Large ROI ROI at (328,190) */
		.width = 3200,
		.height = 1800,
		.hmax_div = 1,
		.min_hmax = 456,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_3200x1800_regs_12bit),
			.regs = mode_3200x1800_regs_12bit,
		},
	},
	{
		/* 3072x2048 - Intermediate ROI at (392,66) */
		.width = 3072,
		.height = 2048,
		.hmax_div = 1,
		.min_hmax = 438,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_3072x2048_regs_12bit),
			.regs = mode_3072x2048_regs_12bit,
		},
	},
	{
		/* 2560x1440 - Intermediate ROI at (648,370) */
		.width = 2560,
		.height = 1440,
		.hmax_div = 1,
		.min_hmax = 365,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_2560x1440_regs_12bit),
			.regs = mode_2560x1440_regs_12bit,
		},
	},
	{
		/* 2304x1728 - Intermediate ROI at (776,226) */
		.width = 2304,
		.height = 1728,
		.hmax_div = 1,
		.min_hmax = 328,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_2304x1728_regs_12bit),
			.regs = mode_2304x1728_regs_12bit,
		},
	},
	{
		/* 2048x2048 - Planetary ROI at (904,66) */
		.width = 2048,
		.height = 2048,
		.hmax_div = 1,
		.min_hmax = 292,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_2048x2048_regs_12bit),
			.regs = mode_2048x2048_regs_12bit,
		},
	},
	{
		/* 1920x1080 - Planetary ROI at (968,550) */
		.width = 1920,
		.height = 1080,
		.hmax_div = 1,
		.min_hmax = 273,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1920x1080_regs_12bit),
			.regs = mode_1920x1080_regs_12bit,
		},
	},
	{
		/* 1600x1200 - Planetary ROI at (1128,490) */
		.width = 1600,
		.height = 1200,
		.hmax_div = 1,
		.min_hmax = 228,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1600x1200_regs_12bit),
			.regs = mode_1600x1200_regs_12bit,
		},
	},
	{
		/* 1280x720 - High speed ROI at (1288,730) */
		.width = 1280,
		.height = 720,
		.hmax_div = 1,
		.min_hmax = 200,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1280x720_regs_12bit),
			.regs = mode_1280x720_regs_12bit,
		},
	},
	{
		/* 1024x1024 - High speed ROI at (1416,578) */
		.width = 1024,
		.height = 1024,
		.hmax_div = 1,
		.min_hmax = 200,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1024x1024_regs_12bit),
			.regs = mode_1024x1024_regs_12bit,
		},
	},
	{
		/* 800x600 - High speed ROI at (1528,790) */
		.width = 800,
		.height = 600,
		.hmax_div = 1,
		.min_hmax = 200,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_800x600_regs_12bit),
			.regs = mode_800x600_regs_12bit,
		},
	},
	{
		/* 640x480 - High speed ROI at (1608,850) */
		.width = 640,
		.height = 480,
		.hmax_div = 1,
		.min_hmax = 200,
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_640x480_regs_12bit),
			.regs = mode_640x480_regs_12bit,
		},
	},
};

/* Total modes: 2 (existing) + 12 (ROI) = 14 */
...
static void imx585_update_hmax(struct imx585 *imx585)
{
	...
	/* Reference HMAX from 4K mode (index 1) for proportional scaling */
	const u32 ref_hmax_defined = 550;
	unsigned int i;
	...
	for (i = 0; i < ARRAY_SIZE(supported_modes); ++i) {
		/* Get the HMAX value defined in the mode table */
		u32 mode_hmax_defined = supported_modes[i].min_hmax;

		/*
		 * Calculate proportional scaling based on the reference mode.
		 * This preserves the relative HMAX differences between modes,
		 * allowing smaller ROIs to achieve higher frame rates.
		 */
		u32 h = (factor * mode_hmax_defined) / ref_hmax_defined;
				 ...
				 struct v4l2_subdev_format *fmt)
{
	...
	/*
	 * Update the crop rectangle to match the selected mode.
	 * This is critical for ROI modes to report their correct
	 * crop coordinates to userspace (libcamera/rpicam-hello).
	 */
