...
/*
 * WINDOWING/CROP MODE REGISTERS
 */
#define IMX585_REG_WINMODE              CCI_REG8(0x3018)
/*
 * WINMODE register [4:0] - Default value is 0x10
 * Bit 4 must remain set (0x10 base), bit 2 enables crop mode (+0x04)
 */
#define IMX585_WINMODE_ALL_PIXEL        0x10
#define IMX585_WINMODE_CROP             0x14

/* Crop window registers (Little Endian 16-bit) */
...
/* ADDMODE for binning control */
#define IMX585_REG_ADDMODE              CCI_REG8(0x301b)
#define IMX585_ADDMODE_NONE             0x00
#define IMX585_ADDMODE_BINNING          0x01
...
/*
 * CROP MODE PARAMETERS - Centered crop windows
 * All values aligned to 4 pixels for Bayer pattern preservation
 * Sensor active area: 3856 x 2180
 */

/* 1920x1080 crop */
#define IMX585_CROP_1920x1080_WIDTH     1920U
#define IMX585_CROP_1920x1080_HEIGHT    1080U
#define IMX585_CROP_1920x1080_H_START   968U
#define IMX585_CROP_1920x1080_V_START   548U

/* 2880x2160 crop */
#define IMX585_CROP_2880x2160_WIDTH     2880U
#define IMX585_CROP_2880x2160_HEIGHT    2160U
#define IMX585_CROP_2880x2160_H_START   488U
#define IMX585_CROP_2880x2160_V_START   8U

/* 1280x720 crop */
#define IMX585_CROP_1280x720_WIDTH      1280U
#define IMX585_CROP_1280x720_HEIGHT     720U
#define IMX585_CROP_1280x720_H_START    1288U
#define IMX585_CROP_1280x720_V_START    728U

/* 800x600 crop */
#define IMX585_CROP_800x600_WIDTH       800U
#define IMX585_CROP_800x600_HEIGHT      600U
...
/*
 * HMAX table for CROP modes - Conservative values for stability
 */
static const u16 HMAX_table_4lane_crop[] = {
	[IMX585_LINK_FREQ_297MHZ]  = 1320,
	[IMX585_LINK_FREQ_360MHZ]  = 1100,
	[IMX585_LINK_FREQ_445MHZ]  = 880,
...
struct imx585_mode {
	...
	/* Flag to indicate crop mode for HMAX table selection */
	bool is_crop_mode;
...
static const struct cci_reg_sequence mode_4k_regs_12bit[] = {
	/* Explicitly set WINMODE to prevent state carryover from crop mode */
	{ IMX585_REG_WINMODE, IMX585_WINMODE_ALL_PIXEL },
	{ IMX585_REG_ADDMODE, IMX585_ADDMODE_NONE }, /* ADDMODE non-binning */
...
static const struct cci_reg_sequence mode_1080_regs_12bit[] = {
	{ IMX585_REG_WINMODE, IMX585_WINMODE_ALL_PIXEL },
	{ IMX585_REG_ADDMODE, IMX585_ADDMODE_BINNING },
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x02 }, /* DIG_CLP_VSTART binning */
};

/* 1920x1080 centered crop */
static const struct cci_reg_sequence mode_1920x1080_crop_regs[] = {
	{ IMX585_REG_WINMODE, IMX585_WINMODE_CROP },
	{ IMX585_REG_ADDMODE, IMX585_ADDMODE_NONE },
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
	{ IMX585_REG_PIX_HST, IMX585_CROP_1920x1080_H_START },
	{ IMX585_REG_PIX_HWIDTH, IMX585_CROP_1920x1080_WIDTH },
	{ IMX585_REG_PIX_VST, IMX585_CROP_1920x1080_V_START },
	{ IMX585_REG_PIX_VWIDTH, IMX585_CROP_1920x1080_HEIGHT },
};

/* 2880x2160 centered crop */
static const struct cci_reg_sequence mode_2880x2160_crop_regs[] = {
	{ IMX585_REG_WINMODE, IMX585_WINMODE_CROP },
	{ IMX585_REG_ADDMODE, IMX585_ADDMODE_NONE },
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
	{ IMX585_REG_PIX_HST, IMX585_CROP_2880x2160_H_START },
	{ IMX585_REG_PIX_HWIDTH, IMX585_CROP_2880x2160_WIDTH },
	{ IMX585_REG_PIX_VST, IMX585_CROP_2880x2160_V_START },
	{ IMX585_REG_PIX_VWIDTH, IMX585_CROP_2880x2160_HEIGHT },
};

/* 1280x720 centered crop */
static const struct cci_reg_sequence mode_1280x720_crop_regs[] = {
	{ IMX585_REG_WINMODE, IMX585_WINMODE_CROP },
	{ IMX585_REG_ADDMODE, IMX585_ADDMODE_NONE },
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
	{ IMX585_REG_PIX_HST, IMX585_CROP_1280x720_H_START },
	{ IMX585_REG_PIX_HWIDTH, IMX585_CROP_1280x720_WIDTH },
	{ IMX585_REG_PIX_VST, IMX585_CROP_1280x720_V_START },
	{ IMX585_REG_PIX_VWIDTH, IMX585_CROP_1280x720_HEIGHT },
};

/* 800x600 centered crop */
static const struct cci_reg_sequence mode_800x600_crop_regs[] = {
	{ IMX585_REG_WINMODE, IMX585_WINMODE_CROP },
	{ IMX585_REG_ADDMODE, IMX585_ADDMODE_NONE },
	{ CCI_REG8(0x3022), 0x02 }, /* ADBIT 12-bit */
	{ CCI_REG8(0x3023), 0x01 }, /* MDBIT 12-bit */
	{ CCI_REG8(0x30d5), 0x04 }, /* DIG_CLP_VSTART non-binning */
	{ IMX585_REG_PIX_HST, IMX585_CROP_800x600_H_START },
	{ IMX585_REG_PIX_HWIDTH, IMX585_CROP_800x600_WIDTH },
	{ IMX585_REG_PIX_VST, IMX585_CROP_800x600_V_START },
...
static struct imx585_mode supported_modes[] = {
	...
	{
		/* 2880x2160 centered crop */
		.width = IMX585_CROP_2880x2160_WIDTH,
		.height = IMX585_CROP_2880x2160_HEIGHT,
		.hmax_div = 1,
		.min_hmax = 660,
		.min_vmax = 2200,
		.is_crop_mode = true,
		.crop = {
			.left = IMX585_CROP_2880x2160_H_START + IMX585_PIXEL_ARRAY_LEFT,
			.top = IMX585_CROP_2880x2160_V_START + IMX585_PIXEL_ARRAY_TOP,
			.width = IMX585_CROP_2880x2160_WIDTH,
			.height = IMX585_CROP_2880x2160_HEIGHT,
		},
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_2880x2160_crop_regs),
			.regs = mode_2880x2160_crop_regs,
		},
	},
	{
		/* 1920x1080 centered crop */
		.width = IMX585_CROP_1920x1080_WIDTH,
		.height = IMX585_CROP_1920x1080_HEIGHT,
		.hmax_div = 1,
		.min_hmax = 660,
		.min_vmax = 1125,
		.is_crop_mode = true,
		.crop = {
			.left = IMX585_CROP_1920x1080_H_START + IMX585_PIXEL_ARRAY_LEFT,
			.top = IMX585_CROP_1920x1080_V_START + IMX585_PIXEL_ARRAY_TOP,
			.width = IMX585_CROP_1920x1080_WIDTH,
			.height = IMX585_CROP_1920x1080_HEIGHT,
		},
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1920x1080_crop_regs),
			.regs = mode_1920x1080_crop_regs,
		},
	},
	{
		/* 1280x720 centered crop */
		.width = IMX585_CROP_1280x720_WIDTH,
		.height = IMX585_CROP_1280x720_HEIGHT,
		.hmax_div = 1,
		.min_hmax = 550,
		.min_vmax = 750,
		.is_crop_mode = true,
		.crop = {
			.left = IMX585_CROP_1280x720_H_START + IMX585_PIXEL_ARRAY_LEFT,
			.top = IMX585_CROP_1280x720_V_START + IMX585_PIXEL_ARRAY_TOP,
			.width = IMX585_CROP_1280x720_WIDTH,
			.height = IMX585_CROP_1280x720_HEIGHT,
		},
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1280x720_crop_regs),
			.regs = mode_1280x720_crop_regs,
		},
	},
	{
		/* 800x600 centered crop */
		.width = IMX585_CROP_800x600_WIDTH,
		.height = IMX585_CROP_800x600_HEIGHT,
		.hmax_div = 1,
		.min_hmax = 440,
		.min_vmax = 630,
		.is_crop_mode = true,
		.crop = {
			.left = IMX585_CROP_800x600_H_START + IMX585_PIXEL_ARRAY_LEFT,
			.top = IMX585_CROP_800x600_V_START + IMX585_PIXEL_ARRAY_TOP,
			.width = IMX585_CROP_800x600_WIDTH,
			.height = IMX585_CROP_800x600_HEIGHT,
		},
		.reg_list = {
