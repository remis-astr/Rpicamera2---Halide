#ifndef HALIDE__generated___ls_apply_calibration_hal_h
#define HALIDE__generated___ls_apply_calibration_hal_h
#include <stdint.h>
...
int ls_apply_calibration_hal(struct halide_buffer_t *_frame_buffer, struct halide_buffer_t *_bg_buffer, struct halide_buffer_t *_flat_buffer, struct halide_buffer_t *_result_buffer);

HALIDE_FUNCTION_ATTRS
int ls_apply_calibration_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *ls_apply_calibration_hal_metadata();
