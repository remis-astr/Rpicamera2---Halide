#ifndef HALIDE__generated___jsk_pipeline_med2_h
#define HALIDE__generated___jsk_pipeline_med2_h
#include <stdint.h>
...
int jsk_pipeline_med2(struct halide_buffer_t *_input_buffer, int32_t _r_gain, int32_t _g_gain, int32_t _b_gain, int32_t _w0, int32_t _w1, int32_t _w2, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int jsk_pipeline_med2_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *jsk_pipeline_med2_metadata();
