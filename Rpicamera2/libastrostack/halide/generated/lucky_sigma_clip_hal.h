#ifndef HALIDE__generated___lucky_sigma_clip_hal_h
#define HALIDE__generated___lucky_sigma_clip_hal_h
#include <stdint.h>
...
int lucky_sigma_clip_hal(struct halide_buffer_t *_frames_buffer, int32_t _n_frames, float _kappa, struct halide_buffer_t *_result_buffer);

HALIDE_FUNCTION_ATTRS
int lucky_sigma_clip_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *lucky_sigma_clip_hal_metadata();
