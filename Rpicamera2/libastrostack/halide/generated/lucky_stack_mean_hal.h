#ifndef HALIDE__generated___lucky_stack_mean_hal_h
#define HALIDE__generated___lucky_stack_mean_hal_h
#include <stdint.h>
...
int lucky_stack_mean_hal(struct halide_buffer_t *_frames_buffer, int32_t _n_frames, struct halide_buffer_t *_result_buffer);

HALIDE_FUNCTION_ATTRS
int lucky_stack_mean_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *lucky_stack_mean_hal_metadata();
