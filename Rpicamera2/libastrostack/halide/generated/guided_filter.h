#ifndef HALIDE__generated___guided_filter_h
#define HALIDE__generated___guided_filter_h
#include <stdint.h>
...
int guided_filter(struct halide_buffer_t *_input_buffer, float _eps, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int guided_filter_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *guided_filter_metadata();
