#ifndef HALIDE__generated___lucky_score_ten_hal_h
#define HALIDE__generated___lucky_score_ten_hal_h
#include <stdint.h>
...
int lucky_score_ten_hal(struct halide_buffer_t *_g1_buffer, int32_t _roi_x0, int32_t _roi_y0, int32_t _roi_w, int32_t _roi_h, struct halide_buffer_t *_score_buffer);

HALIDE_FUNCTION_ATTRS
int lucky_score_ten_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *lucky_score_ten_hal_metadata();
