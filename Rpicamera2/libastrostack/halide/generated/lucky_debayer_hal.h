#ifndef HALIDE__generated___lucky_debayer_hal_h
#define HALIDE__generated___lucky_debayer_hal_h
#include <stdint.h>
...
int lucky_debayer_hal(struct halide_buffer_t *_input_buffer, float _r_gain, float _b_gain, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int lucky_debayer_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *lucky_debayer_hal_metadata();
