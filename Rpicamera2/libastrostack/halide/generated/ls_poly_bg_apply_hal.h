#ifndef HALIDE__generated___ls_poly_bg_apply_hal_h
#define HALIDE__generated___ls_poly_bg_apply_hal_h
#include <stdint.h>
...
int ls_poly_bg_apply_hal(struct halide_buffer_t *_frame_buffer, struct halide_buffer_t *_coeffs_bg_buffer, struct halide_buffer_t *_coeff_fl_buffer, float _alpha, struct halide_buffer_t *_result_buffer);

HALIDE_FUNCTION_ATTRS
int ls_poly_bg_apply_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *ls_poly_bg_apply_hal_metadata();
