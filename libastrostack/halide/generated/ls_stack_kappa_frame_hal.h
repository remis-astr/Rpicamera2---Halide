#ifndef HALIDE__generated___ls_stack_kappa_frame_hal_h
#define HALIDE__generated___ls_stack_kappa_frame_hal_h
#include <stdint.h>
...
int ls_stack_kappa_frame_hal(struct halide_buffer_t *_stacked_in_buffer, struct halide_buffer_t *_cnt_in_buffer, struct halide_buffer_t *_m2_in_buffer, struct halide_buffer_t *_img_buffer, float _kappa, struct halide_buffer_t *_stacked_out_buffer, struct halide_buffer_t *_cnt_out_buffer, struct halide_buffer_t *_m2_out_buffer);

HALIDE_FUNCTION_ATTRS
int ls_stack_kappa_frame_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *ls_stack_kappa_frame_hal_metadata();
