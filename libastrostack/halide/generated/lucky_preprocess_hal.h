#ifndef HALIDE__generated___lucky_preprocess_hal_h
#define HALIDE__generated___lucky_preprocess_hal_h
#include <stdint.h>
...
int lucky_preprocess_hal(struct halide_buffer_t *_input_buffer, float _bl_r, float _bl_g1, float _bl_g2, float _bl_b, struct halide_buffer_t *_bayer_out_buffer, struct halide_buffer_t *_g1_out_buffer);

HALIDE_FUNCTION_ATTRS
int lucky_preprocess_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *lucky_preprocess_hal_metadata();
