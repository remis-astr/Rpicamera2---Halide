#ifndef HALIDE__generated___ls_hot_pixel_removal_hal_h
#define HALIDE__generated___ls_hot_pixel_removal_hal_h
#include <stdint.h>
...
int ls_hot_pixel_removal_hal(struct halide_buffer_t *_input_buffer, float _threshold, float _abs_floor, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int ls_hot_pixel_removal_hal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *ls_hot_pixel_removal_hal_metadata();
